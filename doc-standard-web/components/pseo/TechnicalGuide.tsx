import type { TmsErpGuide, CustomsGuide, CustomsGuideSection, ExpertSection, FinanceGuide, FinanceGuideSection, ShippingGuide, ShippingGuideSection } from "@/lib/pseo/types"
...
export function TechnicalGuide({ guide, customsGuide, financeGuide, shippingGuide }: TechnicalGuideProps) {
  // Render shipping guide sections if available (takes highest priority)
