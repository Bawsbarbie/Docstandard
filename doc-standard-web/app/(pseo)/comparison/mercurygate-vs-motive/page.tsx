...
export const metadata: Metadata = {
  title: "MercuryGate vs Motive (2026): TMS Comparison | DocStandard",
  description: "Compare MercuryGate and Motive side-by-side. Features, pricing, integrations, and use cases for logistics operations.",
  alternates: { canonical: "https://docstandard.co/comparison/mercurygate-vs-motive" },
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-slate-900 mb-6 leading-tight">MercuryGate <span className="text-indigo-500">vs</span> Motive</h1>
              <p className="text-lg md:text-xl text-slate-600 max-w-xl mb-8 leading-relaxed">Compare MercuryGate and Motive for logistics operations. Side-by-side analysis of features, pricing, and capabilities to find your best fit.</p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-slate-400 text-lg mb-8 leading-relaxed">Whether you choose MercuryGate or Motive, you are facing the same problem: getting clean data into your accounting system. Both platforms excel at their core function, but neither connects seamlessly to ERPs out of the box.</p>
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-4 p-6 bg-slate-50 rounded-xl border border-slate-100">
                ...
                <div>
                  ...
                  <p className="text-slate-600">Clean data integration to your ERP. DocStandard bridges MercuryGate and Motive to NetSuite, QuickBooks, SAP, and more.</p>
                </div>
              </div>
            </div>
          </div>
