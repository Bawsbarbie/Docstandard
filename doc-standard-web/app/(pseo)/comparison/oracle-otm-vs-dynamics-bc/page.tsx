...
export const metadata: Metadata = {
  title: "Oracle OTM vs Dynamics Business Central (2026): TMS Comparison | DocStandard",
  description: "Compare Oracle OTM and Dynamics Business Central side-by-side. Features, pricing, integrations, and use cases for logistics operations.",
  alternates: { canonical: "https://docstandard.co/comparison/oracle-otm-vs-dynamics-bc" },
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-slate-900 mb-6 leading-tight">Oracle OTM <span className="text-indigo-500">vs</span> Dynamics Business Central</h1>
              <p className="text-lg md:text-xl text-slate-600 max-w-xl mb-8 leading-relaxed">Compare Oracle OTM and Dynamics Business Central for logistics operations.</p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-slate-400 text-lg mb-8">Whether you choose Oracle OTM or Dynamics Business Central, you are facing the same problem: getting clean data into your accounting system.</p>
      ...
      <section id="comparison-table" className="py-20 px-6 bg-slate-50">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden shadow-sm">
            ...
            <div className="grid grid-cols-3 border-b border-slate-100"><div className="px-6 py-4 font-medium text-slate-900">Starting Price</div><div className="px-6 py-4 text-center text-slate-600">$200K/year</div><div className="px-6 py-4 text-center text-slate-600">$70/user/month</div></div>
