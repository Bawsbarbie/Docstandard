...
export const metadata: Metadata = {
  title: "CargoWise vs Dynamics Business Central (2026): TMS Comparison | DocStandard",
  description:
    "Compare CargoWise and Dynamics Business Central side-by-side. Features, pricing, integrations, and use cases for logistics operations.",
  alternates: {
    canonical: "https://docstandard.co/comparison/cargowise-vs-dynamics-bc",
  },
  robots: {
    index: false,
    follow: false,
...
const comparisonFeatures = [
  { feature: "Category", "cargowise": "TMS", "dynamics-bc": "ERP" },
  { feature: "Starting Price", "cargowise": "$50K/year", "dynamics-bc": "$70/user/month" },
  { feature: "Target Market", "cargowise": "Enterprise ($50M+)", "dynamics-bc": "SMB to mid-market" },
  { feature: "Best For", "cargowise": "Freight forwarding", "dynamics-bc": "Business management" },
  { feature: "Implementation", "cargowise": "3-12 months", "dynamics-bc": "2-6 weeks" },
  { feature: "Integration Type", "cargowise": "eAdapter (XML)", "dynamics-bc": "REST API / Custom" },
  { feature: "Cloud/On-prem", "cargowise": "Cloud-native", "dynamics-bc": "Cloud + On-prem" },
  { feature: "Mobile Support", "cargowise": "✓ Limited to Full", "dynamics-bc": "✓ Limited to Full" },
  { feature: "API Available", "cargowise": "✓ Yes", "dynamics-bc": "✓ Yes" },
  { feature: "DocStandard Compatible", "cargowise": "✓ Yes", "dynamics-bc": "✓ Yes" },
  { feature: "Data Extraction", "cargowise": "PDF, Email, API, EDI", "dynamics-bc": "PDF, Email, API, EDI" },
  { feature: "Common Pain Point", "cargowise": "ERP integration gaps", "dynamics-bc": "Document processing" },
]

const painPoints = [
  {
    title: "Data Format Mismatch",
    description: "CargoWise and Dynamics Business Central use different data formats. Getting data between them requires manual reformatting or expensive custom integration."
  },
  {
  ...
  },
  {
    ...
    description: "Building custom integration between CargoWise and Dynamics Business Central requires expensive developers and ongoing maintenance."
  }
]

const faqs = [
  {
    q: "We use CargoWise but receive documents that need manual entry. Can DocStandard help automate this?",
    a: "Yes. DocStandard extracts structured data from any document format—PDFs, emails, EDI—and delivers it in CargoWise-compatible format via API or direct import. This eliminates 4-6 hours of daily manual entry, reduces errors by 95%, and saves $45K+ annually in labor costs."
  },
  {
    q: "We're migrating from CargoWise to Dynamics Business Central. How can DocStandard simplify the data transfer?",
    a: "DocStandard normalizes and transforms records between CargoWise and Dynamics Business Central during migration. We handle complex field mapping and data validation, saving 3-4 weeks of migration time and ensuring data integrity across systems."
  },
  {
    q: "Our team uses CargoWise but our accounting department needs the data in a different format. What's the solution?",
    a: "DocStandard bridges CargoWise with any ERP or accounting system by extracting data, normalizing formats, and delivering journal-ready imports. This eliminates manual CSV exports and reduces month-end close from 5 days to 2 days."
  },
  {
    q: "We have clients using both CargoWise and Dynamics Business Central. Can DocStandard normalize data from both platforms?",
    a: "Absolutely. DocStandard accepts data from both CargoWise and Dynamics Business Central, normalizes it to a standard schema, and delivers consistent output to your ERP—regardless of which platforms your partners use."
  },
  {
    q: "How quickly can DocStandard integrate with our existing CargoWise or Dynamics Business Central setup?",
...
export default function CargowiseVsDynamicsBcPage() {
  return (
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-slate-900 mb-6 leading-tight">
                CargoWise <span className="text-indigo-500">vs</span> Dynamics Business Central
              </h1>
              
              <p className="text-lg md:text-xl text-slate-600 max-w-xl mb-8 leading-relaxed">
                Compare CargoWise and Dynamics Business Central for logistics operations. 
            ...
            <div className="relative">
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-indigo-100/50 to-sky-100/50 rounded-3xl blur-3xl" />
              ...
              <div className="relative bg-white rounded-3xl border border-slate-200 shadow-xl p-8">
                <svg viewBox="0 0 400 280" className="w-full h-auto">
                  ...
                  <text x="95" y="75" textAnchor="middle" fill="white" fontSize="13" fontWeight="bold">CargoWise</text>
                  ...
                  {/* Dynamics Business Central Box */}
                  <rect x="230" y="40" width="150" height="200" rx="16" fill="#0ea5e9" opacity="0.1" stroke="#0ea5e9" strokeWidth="2"/>
                  <rect x="240" y="50" width="130" height="40" rx="8" fill="#0ea5e9"/>
                  <text x="305" y="75" textAnchor="middle" fill="white" fontSize="10" fontWeight="bold">Dynamics Business Central</text>
                  
                  {/* Dynamics Business Central Features */}
                  <rect x="255" y="105" width="100" height="12" rx="6" fill="#0ea5e9" opacity="0.3"/>
                  <rect x="255" y="125" width="80" height="12" rx="6" fill="#0ea5e9" opacity="0.3"/>
                  <rect x="255" y="145" width="90" height="12" rx="6" fill="#0ea5e9" opacity="0.3"/>
                  <rect x="255" y="165" width="70" height="12" rx="6" fill="#0ea5e9" opacity="0.3"/>
                  <rect x="255" y="185" width="85" height="12" rx="6" fill="#0ea5e9" opacity="0.3"/>
                  <rect x="255" y="205" width="60" height="12" rx="6" fill="#0ea5e9" opacity="0.3"/>
                ...
                <div className="flex justify-between mt-4 px-4">
                  ...
                  <div className="text-center">
                    <div className="w-3 h-3 rounded-full bg-sky-600 mx-auto mb-1"></div>
                    <span className="text-sm font-semibold text-slate-700">ERP</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-slate-400 text-lg mb-8 leading-relaxed">
                Whether you choose CargoWise or Dynamics Business Central, you are facing the same problem: 
            ...
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-r from-indigo-500/20 to-sky-500/20 rounded-2xl blur-2xl" />
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden shadow-sm">
            ...
            <div className="grid grid-cols-3 bg-slate-100 border-b border-slate-200">
              ...
              <div className="px-6 py-4 font-bold text-center text-indigo-700 bg-indigo-50">CargoWise</div>
              <div className="px-6 py-4 font-bold text-center text-sky-700 bg-sky-50">Dynamics Business Central</div>
            </div>
            ...
            {comparisonFeatures.map((row, index) => (
              ...
              >
                ...
                <div className="px-6 py-4 text-center text-slate-600">{row["cargowise"]}</div>
                <div className="px-6 py-4 text-center text-slate-600">{row["dynamics-bc"]}</div>
              </div>
            ))}
          </div>
          ...
          <div className="mt-8 grid md:grid-cols-3 gap-6">
            <div className="bg-white p-6 rounded-xl border border-slate-200">
              <h4 className="font-semibold text-slate-900 mb-2">CargoWise Advantage</h4>
              <p className="text-sm text-slate-600">
                Best suited for Enterprise ($50M+) operations with tms focus.
              </p>
            </div>
            <div className="bg-white p-6 rounded-xl border border-slate-200">
              <h4 className="font-semibold text-slate-900 mb-2">Dynamics Business Central Advantage</h4>
              <p className="text-sm text-slate-600">
                Best suited for SMB to mid-market operations with erp focus.
              </p>
            </div>
            <div className="bg-white p-6 rounded-xl border border-slate-200">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            <div>
              ...
              <div className="rounded-2xl bg-indigo-50 border border-indigo-100 p-6">
                ...
                <div className="mb-4">
                  ...
                  <p className="text-slate-600">Enterprise ($50M+) businesses needing tms capabilities.</p>
                </div>                
                <div>
                  <div className="flex items-center gap-2 text-indigo-700 font-medium mb-2">
                    <CheckCircle className="w-4 h-4" />
                    Dynamics Business Central Best For
                  </div>
                  <p className="text-slate-600">SMB to mid-market businesses needing erp capabilities.</p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <div className="flex gap-4 p-6 bg-slate-50 rounded-xl border border-slate-100">
                ...
                <div>
                  <h3 className="font-bold text-slate-900 mb-2">Choose CargoWise If...</h3>
                  <p className="text-slate-600">
                    You are enterprise ($50m+), need tms functionality, 
                    and your budget aligns with $50K/year pricing.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4 p-6 bg-slate-50 rounded-xl border border-slate-100">
                ...
                <div>
                  <h3 className="font-bold text-slate-900 mb-2">Choose Dynamics Business Central If...</h3>
                  <p className="text-slate-600">
                    You are smb to mid-market, need erp functionality, 
                    and your budget aligns with $70/user/month pricing.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4 p-6 bg-slate-50 rounded-xl border border-slate-100">
                ...
                <div>
                  ...
                  <p className="text-slate-600">
                    Clean data integration to your ERP. DocStandard bridges CargoWise and Dynamics Business Central 
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-8 rounded-2xl bg-gradient-to-br from-indigo-50 to-white border border-indigo-100">
              ...
              <p className="text-slate-600">
                Works with CargoWise, Dynamics Business Central, or any platform. We normalize data 
            ...
            <div className="p-8 rounded-2xl bg-gradient-to-br from-indigo-50 to-white border border-indigo-100">
              ...
              <p className="text-slate-600">
                ...
                whether you use CargoWise or Dynamics Business Central.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-8 rounded-2xl bg-slate-50 border border-slate-200">
              ...
              <p className="text-slate-700 mb-6">
                &quot;We evaluated both CargoWise and Dynamics Business Central. DocStandard made the data 
