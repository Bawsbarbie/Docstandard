...
export const metadata: Metadata = {
  title: "SAP TM vs 3PL Central (2026): TMS Comparison | DocStandard",
  description: "Compare SAP TM and 3PL Central side-by-side. Features, pricing, integrations, and use cases for logistics operations.",
  alternates: { canonical: "https://docstandard.co/comparison/sap-tm-vs-3pl-central" },
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-slate-900 mb-6 leading-tight">SAP TM <span className="text-indigo-500">vs</span> 3PL Central</h1>
              <p className="text-lg md:text-xl text-slate-600 max-w-xl mb-8 leading-relaxed">Compare SAP TM and 3PL Central for logistics operations.</p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-slate-400 text-lg mb-8">Whether you choose SAP TM or 3PL Central, you are facing the same problem: getting clean data into your accounting system.</p>
      ...
      <section id="comparison-table" className="py-20 px-6 bg-slate-50">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden shadow-sm">
            ...
            <div className="grid grid-cols-3 border-b border-slate-100"><div className="px-6 py-4 font-medium text-slate-900">Category</div><div className="px-6 py-4 text-center text-slate-600">TMS</div><div className="px-6 py-4 text-center text-slate-600">WMS</div></div>
            ...
            <div className="grid grid-cols-3"><div className="px-6 py-4 font-medium text-slate-900">Target Market</div><div className="px-6 py-4 text-center text-slate-600">Large enterprises</div><div className="px-6 py-4 text-center text-slate-600">3PLs and warehouses</div></div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-4 p-6 bg-slate-50 rounded-xl border border-slate-100">
              ...
              <div><h3 className="font-bold text-slate-900 mb-2">Choose 3PL Central If...</h3><p className="text-slate-600">You need wms functionality for 3pls and warehouses.</p></div>
            </div>
            <div className="flex gap-4 p-6 bg-slate-50 rounded-xl border border-slate-100">
              <div className="w-12 h-12 bg-indigo-600 rounded-xl flex items-center justify-center flex-shrink-0"><CheckCircle className="w-6 h-6 text-white" /></div>
