...
export const metadata: Metadata = {
  title: "CargoWise vs SAP S/4HANA (2026): TMS Comparison | DocStandard",
  description:
    "Compare CargoWise and SAP S/4HANA side-by-side. Features, pricing, integrations, and use cases for logistics operations.",
  alternates: {
    canonical: "https://docstandard.co/comparison/cargowise-vs-sap-s4hana",
  },
  robots: {
    index: false,
    follow: false,
...
const comparisonFeatures = [
  { feature: "Category", "cargowise": "TMS", "sap-s4hana": "ERP" },
  { feature: "Starting Price", "cargowise": "$50K/year", "sap-s4hana": "Custom (enterprise)" },
  { feature: "Target Market", "cargowise": "Enterprise ($50M+)", "sap-s4hana": "Large enterprises" },
  { feature: "Best For", "cargowise": "Freight forwarding", "sap-s4hana": "Business management" },
  { feature: "Implementation", "cargowise": "3-12 months", "sap-s4hana": "3-12 months" },
  { feature: "Integration Type", "cargowise": "eAdapter (XML)", "sap-s4hana": "REST API / Custom" },
  { feature: "Cloud/On-prem", "cargowise": "Cloud-native", "sap-s4hana": "Cloud + On-prem" },
  { feature: "Mobile Support", "cargowise": "✓ Limited to Full", "sap-s4hana": "✓ Limited to Full" },
  { feature: "API Available", "cargowise": "✓ Yes", "sap-s4hana": "✓ Yes" },
  { feature: "DocStandard Compatible", "cargowise": "✓ Yes", "sap-s4hana": "✓ Yes" },
  { feature: "Data Extraction", "cargowise": "PDF, Email, API, EDI", "sap-s4hana": "PDF, Email, API, EDI" },
  { feature: "Common Pain Point", "cargowise": "ERP integration gaps", "sap-s4hana": "Document processing" },
]

const painPoints = [
  {
    title: "Data Format Mismatch",
    description: "CargoWise and SAP S/4HANA use different data formats. Getting data between them requires manual reformatting or expensive custom integration."
  },
  {
  ...
  },
  {
    ...
    description: "Building custom integration between CargoWise and SAP S/4HANA requires expensive developers and ongoing maintenance."
  }
]
...
const faqs = [
  ...
  {
    q: "We're migrating from CargoWise to SAP S/4HANA. How can DocStandard simplify the data transfer?",
    a: "DocStandard normalizes and transforms records between CargoWise and SAP S/4HANA during migration. We handle complex field mapping and data validation, saving 3-4 weeks of migration time and ensuring data integrity across systems."
  },
  {
  ...
  {
    q: "We have clients using both CargoWise and SAP S/4HANA. Can DocStandard normalize data from both platforms?",
    a: "Absolutely. DocStandard accepts data from both CargoWise and SAP S/4HANA, normalizes it to a standard schema, and delivers consistent output to your ERP—regardless of which platforms your partners use."
  },
  {
    q: "How quickly can DocStandard integrate with our existing CargoWise or SAP S/4HANA setup?",
...
export default function CargowiseVsSapS4hanaPage() {
  return (
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-slate-900 mb-6 leading-tight">
                CargoWise <span className="text-indigo-500">vs</span> SAP S/4HANA
              </h1>
              
              <p className="text-lg md:text-xl text-slate-600 max-w-xl mb-8 leading-relaxed">
                Compare CargoWise and SAP S/4HANA for logistics operations. 
            ...
            <div className="relative">
              ...
              <div className="relative bg-white rounded-3xl border border-slate-200 shadow-xl p-8">
                <svg viewBox="0 0 400 280" className="w-full h-auto">
                  ...
                  <text x="305" y="75" textAnchor="middle" fill="white" fontSize="10" fontWeight="bold">SAP S/4HANA</text>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-slate-400 text-lg mb-8 leading-relaxed">
                Whether you choose CargoWise or SAP S/4HANA, you are facing the same problem: 
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden shadow-sm">
            ...
            <div className="grid grid-cols-3 bg-slate-100 border-b border-slate-200">
              ...
              <div className="px-6 py-4 font-bold text-center text-blue-700 bg-blue-50">SAP S/4HANA</div>
            </div>
            ...
            {comparisonFeatures.map((row, index) => (
              ...
              >
                ...
                <div className="px-6 py-4 text-center text-slate-600">{row["sap-s4hana"]}</div>
              </div>
            ))}
          </div>
          ...
          <div className="mt-8 grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-white p-6 rounded-xl border border-slate-200">
              <h4 className="font-semibold text-slate-900 mb-2">SAP S/4HANA Advantage</h4>
              <p className="text-sm text-slate-600">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-4 p-6 bg-slate-50 rounded-xl border border-slate-100">
                ...
                <div>
                  <h3 className="font-bold text-slate-900 mb-2">Choose SAP S/4HANA If...</h3>
                  <p className="text-slate-600">
              ...
              <div className="flex gap-4 p-6 bg-slate-50 rounded-xl border border-slate-100">
                ...
                <div>
                  ...
                  <p className="text-slate-600">
                    Clean data integration to your ERP. DocStandard bridges CargoWise and SAP S/4HANA 
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-8 rounded-2xl bg-gradient-to-br from-indigo-50 to-white border border-indigo-100">
              ...
              <p className="text-slate-600">
                Works with CargoWise, SAP S/4HANA, or any platform. We normalize data 
            ...
            <div className="p-8 rounded-2xl bg-gradient-to-br from-indigo-50 to-white border border-indigo-100">
              ...
              <p className="text-slate-600">
                ...
                whether you use CargoWise or SAP S/4HANA.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-8 rounded-2xl bg-slate-50 border border-slate-200">
              ...
              <p className="text-slate-700 mb-6">
                &quot;We evaluated both CargoWise and SAP S/4HANA. DocStandard made the data 
