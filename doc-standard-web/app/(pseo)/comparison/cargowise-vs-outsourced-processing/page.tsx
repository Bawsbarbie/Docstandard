...
export const metadata: Metadata = {
  title: "CargoWise vs Outsourced Processing (2026): TMS Comparison | DocStandard",
  description:
    "Compare CargoWise and Outsourced Processing side-by-side. Features, pricing, integrations, and use cases for logistics operations.",
  alternates: {
    canonical: "https://docstandard.co/comparison/cargowise-vs-outsourced-processing",
  },
  robots: {
    index: false,
    follow: false,
...
const comparisonFeatures = [
  { feature: "Category", "cargowise": "TMS", "outsourced-processing": "Tools" },
  { feature: "Starting Price", "cargowise": "$50K/year", "outsourced-processing": "$2-5/document" },
  { feature: "Target Market", "cargowise": "Enterprise ($50M+)", "outsourced-processing": "Variable volume operations" },
  { feature: "Best For", "cargowise": "Freight forwarding", "outsourced-processing": "Process automation" },
  { feature: "Implementation", "cargowise": "3-12 months", "outsourced-processing": "1-4 weeks" },
  { feature: "Integration Type", "cargowise": "eAdapter (XML)", "outsourced-processing": "Varies" },
  { feature: "Cloud/On-prem", "cargowise": "Cloud-native", "outsourced-processing": "N/A" },
  { feature: "Mobile Support", "cargowise": "✓ Limited to Full", "outsourced-processing": "N/A" },
  { feature: "API Available", "cargowise": "✓ Yes", "outsourced-processing": "✓ Yes" },
  { feature: "DocStandard Compatible", "cargowise": "✓ Yes", "outsourced-processing": "✓ Yes" },
  { feature: "Data Extraction", "cargowise": "PDF, Email, API, EDI", "outsourced-processing": "Varies" },
  { feature: "Common Pain Point", "cargowise": "ERP integration gaps", "outsourced-processing": "Error rates / Scalability" },
]

const painPoints = [
  {
    title: "Data Format Mismatch",
    description: "CargoWise and Outsourced Processing use different data formats. Getting data between them requires manual reformatting or expensive custom integration."
  },
  {
  ...
  },
  {
    ...
    description: "Building custom integration between CargoWise and Outsourced Processing requires expensive developers and ongoing maintenance."
  }
]
...
const faqs = [
  ...
  {
    q: "We're migrating from CargoWise to Outsourced Processing. How can DocStandard simplify the data transfer?",
    a: "DocStandard normalizes and transforms records between CargoWise and Outsourced Processing during migration. We handle complex field mapping and data validation, saving 3-4 weeks of migration time and ensuring data integrity across systems."
  },
  {
  ...
  {
    q: "We have clients using both CargoWise and Outsourced Processing. Can DocStandard normalize data from both platforms?",
    a: "Absolutely. DocStandard accepts data from both CargoWise and Outsourced Processing, normalizes it to a standard schema, and delivers consistent output to your ERP—regardless of which platforms your partners use."
  },
  {
    q: "How quickly can DocStandard integrate with our existing CargoWise or Outsourced Processing setup?",
...
export default function CargowiseVsOutsourcedProcessingPage() {
  return (
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-slate-900 mb-6 leading-tight">
                CargoWise <span className="text-indigo-500">vs</span> Outsourced Processing
              </h1>
              
              <p className="text-lg md:text-xl text-slate-600 max-w-xl mb-8 leading-relaxed">
                Compare CargoWise and Outsourced Processing for logistics operations. 
            ...
            <div className="relative">
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-indigo-100/50 to-violet-100/50 rounded-3xl blur-3xl" />
              ...
              <div className="relative bg-white rounded-3xl border border-slate-200 shadow-xl p-8">
                <svg viewBox="0 0 400 280" className="w-full h-auto">
                  ...
                  <text x="305" y="75" textAnchor="middle" fill="white" fontSize="10" fontWeight="bold">Outsourced Processing</text>
                  
                  {/* Outsourced Processing Features */}
                ...
                <div className="flex justify-between mt-4 px-4">
                  ...
                  <div className="text-center">
                    <div className="w-3 h-3 rounded-full bg-violet-600 mx-auto mb-1"></div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-slate-400 text-lg mb-8 leading-relaxed">
                Whether you choose CargoWise or Outsourced Processing, you are facing the same problem: 
            ...
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-r from-indigo-500/20 to-violet-500/20 rounded-2xl blur-2xl" />
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden shadow-sm">
            ...
            <div className="grid grid-cols-3 bg-slate-100 border-b border-slate-200">
              ...
              <div className="px-6 py-4 font-bold text-center text-violet-700 bg-violet-50">Outsourced Processing</div>
            </div>
            ...
            {comparisonFeatures.map((row, index) => (
              ...
              >
                ...
                <div className="px-6 py-4 text-center text-slate-600">{row["outsourced-processing"]}</div>
              </div>
            ))}
          </div>
          ...
          <div className="mt-8 grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-white p-6 rounded-xl border border-slate-200">
              <h4 className="font-semibold text-slate-900 mb-2">Outsourced Processing Advantage</h4>
              <p className="text-sm text-slate-600">
                Best suited for Variable volume operations operations with tools focus.
              </p>
            </div>
            <div className="bg-white p-6 rounded-xl border border-slate-200">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            <div>
              ...
              <div className="rounded-2xl bg-indigo-50 border border-indigo-100 p-6">
                ...
                <div>
                  <div className="flex items-center gap-2 text-indigo-700 font-medium mb-2">
                    <CheckCircle className="w-4 h-4" />
                    Outsourced Processing Best For
                  </div>
                  <p className="text-slate-600">Variable volume operations businesses needing tools capabilities.</p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-4 p-6 bg-slate-50 rounded-xl border border-slate-100">
                ...
                <div>
                  <h3 className="font-bold text-slate-900 mb-2">Choose Outsourced Processing If...</h3>
                  <p className="text-slate-600">
                    You are variable volume operations, need tools functionality, 
                    and your budget aligns with $2-5/document pricing.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4 p-6 bg-slate-50 rounded-xl border border-slate-100">
                ...
                <div>
                  ...
                  <p className="text-slate-600">
                    Clean data integration to your ERP. DocStandard bridges CargoWise and Outsourced Processing 
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-8 rounded-2xl bg-gradient-to-br from-indigo-50 to-white border border-indigo-100">
              ...
              <p className="text-slate-600">
                Works with CargoWise, Outsourced Processing, or any platform. We normalize data 
            ...
            <div className="p-8 rounded-2xl bg-gradient-to-br from-indigo-50 to-white border border-indigo-100">
              ...
              <p className="text-slate-600">
                ...
                whether you use CargoWise or Outsourced Processing.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-8 rounded-2xl bg-slate-50 border border-slate-200">
              ...
              <p className="text-slate-700 mb-6">
                &quot;We evaluated both CargoWise and Outsourced Processing. DocStandard made the data 
