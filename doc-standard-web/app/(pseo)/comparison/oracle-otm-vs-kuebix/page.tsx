...
export const metadata: Metadata = {
  title: "Oracle OTM vs Kuebix (2026): TMS Comparison | DocStandard",
  description: "Compare Oracle OTM and Kuebix side-by-side. Features, pricing, integrations, and use cases for logistics operations.",
  alternates: { canonical: "https://docstandard.co/comparison/oracle-otm-vs-kuebix" },
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-slate-900 mb-6 leading-tight">Oracle OTM <span className="text-indigo-500">vs</span> Kuebix</h1>
              <p className="text-lg md:text-xl text-slate-600 max-w-xl mb-8 leading-relaxed">Compare Oracle OTM and Kuebix for logistics operations.</p>
            ...
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-br from-amber-100/50 to-teal-100/50 rounded-3xl blur-3xl" />
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-slate-400 text-lg mb-8">Whether you choose Oracle OTM or Kuebix, you are facing the same problem: getting clean data into your accounting system.</p>
            ...
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-r from-amber-500/20 to-teal-500/20 rounded-2xl blur-2xl" />
      ...
      <section id="comparison-table" className="py-20 px-6 bg-slate-50">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden shadow-sm">
            ...
            <div className="grid grid-cols-3 border-b border-slate-100"><div className="px-6 py-4 font-medium text-slate-900">Starting Price</div><div className="px-6 py-4 text-center text-slate-600">$200K/year</div><div className="px-6 py-4 text-center text-slate-600">Freemium available</div></div>
