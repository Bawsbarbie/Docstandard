...
export const metadata: Metadata = {
  title: "CargoWise vs Flexport (2026): TMS Comparison | DocStandard",
  description:
    "Compare CargoWise and Flexport side-by-side. Features, pricing, integrations, and use cases for logistics operations.",
  alternates: {
    canonical: "https://docstandard.co/comparison/cargowise-vs-flexport",
  },
  robots: {
    index: false,
    follow: false,
...
const comparisonFeatures = [
  { feature: "Category", "cargowise": "TMS", "flexport": "Forwarder" },
  { feature: "Starting Price", "cargowise": "$50K/year", "flexport": "Per-shipment" },
  { feature: "Target Market", "cargowise": "Enterprise ($50M+)", "flexport": "Regular shippers" },
  { feature: "Best For", "cargowise": "Freight forwarding", "flexport": "International shipping" },
  { feature: "Implementation", "cargowise": "3-12 months", "flexport": "1-4 weeks" },
  { feature: "Integration Type", "cargowise": "eAdapter (XML)", "flexport": "REST API / Custom" },
  { feature: "Cloud/On-prem", "cargowise": "Cloud-native", "flexport": "Cloud-native" },
  { feature: "Mobile Support", "cargowise": "✓ Limited to Full", "flexport": "✓ Limited to Full" },
  { feature: "API Available", "cargowise": "✓ Yes", "flexport": "✓ Yes" },
  { feature: "DocStandard Compatible", "cargowise": "✓ Yes", "flexport": "✓ Yes" },
  { feature: "Data Extraction", "cargowise": "PDF, Email, API, EDI", "flexport": "PDF, Email, API, EDI" },
  { feature: "Common Pain Point", "cargowise": "ERP integration gaps", "flexport": "Data export limitations" },
]

const painPoints = [
  {
    title: "Data Format Mismatch",
    description: "CargoWise and Flexport use different data formats. Getting data between them requires manual reformatting or expensive custom integration."
  },
  {
  ...
  },
  {
    ...
    description: "Building custom integration between CargoWise and Flexport requires expensive developers and ongoing maintenance."
  }
]
...
const faqs = [
  ...
  {
    q: "We're migrating from CargoWise to Flexport. How can DocStandard simplify the data transfer?",
    a: "DocStandard normalizes and transforms records between CargoWise and Flexport during migration. We handle complex field mapping and data validation, saving 3-4 weeks of migration time and ensuring data integrity across systems."
  },
  {
  ...
  {
    q: "We have clients using both CargoWise and Flexport. Can DocStandard normalize data from both platforms?",
    a: "Absolutely. DocStandard accepts data from both CargoWise and Flexport, normalizes it to a standard schema, and delivers consistent output to your ERP—regardless of which platforms your partners use."
  },
  {
    q: "How quickly can DocStandard integrate with our existing CargoWise or Flexport setup?",
...
export default function CargowiseVsFlexportPage() {
  return (
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-slate-900 mb-6 leading-tight">
                CargoWise <span className="text-indigo-500">vs</span> Flexport
              </h1>
              
              <p className="text-lg md:text-xl text-slate-600 max-w-xl mb-8 leading-relaxed">
                Compare CargoWise and Flexport for logistics operations. 
            ...
            <div className="relative">
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-indigo-100/50 to-pink-100/50 rounded-3xl blur-3xl" />
              ...
              <div className="relative bg-white rounded-3xl border border-slate-200 shadow-xl p-8">
                <svg viewBox="0 0 400 280" className="w-full h-auto">
                  ...
                  {/* Flexport Box */}
                  <rect x="230" y="40" width="150" height="200" rx="16" fill="#ec4899" opacity="0.1" stroke="#ec4899" strokeWidth="2"/>
                  <rect x="240" y="50" width="130" height="40" rx="8" fill="#ec4899"/>
                  <text x="305" y="75" textAnchor="middle" fill="white" fontSize="13" fontWeight="bold">Flexport</text>
                  
                  {/* Flexport Features */}
                  <rect x="255" y="105" width="100" height="12" rx="6" fill="#ec4899" opacity="0.3"/>
                  <rect x="255" y="125" width="80" height="12" rx="6" fill="#ec4899" opacity="0.3"/>
                  <rect x="255" y="145" width="90" height="12" rx="6" fill="#ec4899" opacity="0.3"/>
                  <rect x="255" y="165" width="70" height="12" rx="6" fill="#ec4899" opacity="0.3"/>
                  <rect x="255" y="185" width="85" height="12" rx="6" fill="#ec4899" opacity="0.3"/>
                  <rect x="255" y="205" width="60" height="12" rx="6" fill="#ec4899" opacity="0.3"/>
                ...
                <div className="flex justify-between mt-4 px-4">
                  ...
                  <div className="text-center">
                    <div className="w-3 h-3 rounded-full bg-pink-600 mx-auto mb-1"></div>
                    <span className="text-sm font-semibold text-slate-700">Forwarder</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-slate-400 text-lg mb-8 leading-relaxed">
                Whether you choose CargoWise or Flexport, you are facing the same problem: 
            ...
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-r from-indigo-500/20 to-pink-500/20 rounded-2xl blur-2xl" />
      ...
      <section id="comparison-table" className="py-20 px-6 bg-slate-50">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mt-8 grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-white p-6 rounded-xl border border-slate-200">
              <h4 className="font-semibold text-slate-900 mb-2">Flexport Advantage</h4>
              <p className="text-sm text-slate-600">
                Best suited for Regular shippers operations with forwarder focus.
              </p>
            </div>
            <div className="bg-white p-6 rounded-xl border border-slate-200">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            <div>
              ...
              <div className="rounded-2xl bg-indigo-50 border border-indigo-100 p-6">
                ...
                <div>
                  ...
                  <p className="text-slate-600">Regular shippers businesses needing forwarder capabilities.</p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-4 p-6 bg-slate-50 rounded-xl border border-slate-100">
                ...
                <div>
                  <h3 className="font-bold text-slate-900 mb-2">Choose Flexport If...</h3>
                  <p className="text-slate-600">
                    You are regular shippers, need forwarder functionality, 
                    and your budget aligns with Per-shipment pricing.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4 p-6 bg-slate-50 rounded-xl border border-slate-100">
                ...
                <div>
                  ...
                  <p className="text-slate-600">
                    Clean data integration to your ERP. DocStandard bridges CargoWise and Flexport 
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-8 rounded-2xl bg-gradient-to-br from-indigo-50 to-white border border-indigo-100">
              ...
              <p className="text-slate-600">
                Works with CargoWise, Flexport, or any platform. We normalize data 
            ...
            <div className="p-8 rounded-2xl bg-gradient-to-br from-indigo-50 to-white border border-indigo-100">
              ...
              <p className="text-slate-600">
                ...
                whether you use CargoWise or Flexport.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-8 rounded-2xl bg-slate-50 border border-slate-200">
              ...
              <p className="text-slate-700 mb-6">
                &quot;We evaluated both CargoWise and Flexport. DocStandard made the data 
