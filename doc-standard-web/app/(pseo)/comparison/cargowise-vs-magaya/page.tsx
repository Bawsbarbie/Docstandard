...
export const metadata: Metadata = {
  title: "CargoWise vs Magaya (2026): TMS Comparison | DocStandard",
  description:
    "Compare CargoWise and Magaya side-by-side. Features, pricing, integrations, and use cases for logistics operations.",
  alternates: {
    canonical: "https://docstandard.co/comparison/cargowise-vs-magaya",
  },
  robots: {
    index: false,
    follow: false,
...
const comparisonFeatures = [
  { feature: "Category", "cargowise": "TMS", "magaya": "TMS" },
  { feature: "Starting Price", "cargowise": "$50K/year", "magaya": "$500/month" },
  { feature: "Target Market", "cargowise": "Enterprise ($50M+)", "magaya": "SMB (&lt;$50M)" },
  { feature: "Best For", "cargowise": "Freight forwarding", "magaya": "Freight forwarding" },
  { feature: "Implementation", "cargowise": "3-12 months", "magaya": "2-6 weeks" },
  { feature: "Integration Type", "cargowise": "eAdapter (XML)", "magaya": "REST API / Custom" },
  { feature: "Cloud/On-prem", "cargowise": "Cloud-native", "magaya": "Cloud-native" },
  { feature: "Mobile Support", "cargowise": "✓ Limited to Full", "magaya": "✓ Limited to Full" },
  { feature: "API Available", "cargowise": "✓ Yes", "magaya": "✓ Yes" },
  { feature: "DocStandard Compatible", "cargowise": "✓ Yes", "magaya": "✓ Yes" },
  { feature: "Data Extraction", "cargowise": "PDF, Email, API, EDI", "magaya": "PDF, Email, API, EDI" },
  { feature: "Common Pain Point", "cargowise": "ERP integration gaps", "magaya": "ERP integration gaps" },
]

const painPoints = [
  {
    title: "Data Format Mismatch",
    description: "CargoWise and Magaya use different data formats. Getting data between them requires manual reformatting or expensive custom integration."
  },
  {
  ...
  },
  {
    ...
    description: "Building custom integration between CargoWise and Magaya requires expensive developers and ongoing maintenance."
  }
]
...
const faqs = [
  ...
  {
    q: "We're migrating from CargoWise to Magaya. How can DocStandard simplify the data transfer?",
    a: "DocStandard normalizes and transforms records between CargoWise and Magaya during migration. We handle complex field mapping and data validation, saving 3-4 weeks of migration time and ensuring data integrity across systems."
  },
  {
  ...
  {
    q: "We have clients using both CargoWise and Magaya. Can DocStandard normalize data from both platforms?",
    a: "Absolutely. DocStandard accepts data from both CargoWise and Magaya, normalizes it to a standard schema, and delivers consistent output to your ERP—regardless of which platforms your partners use."
  },
  {
    q: "How quickly can DocStandard integrate with our existing CargoWise or Magaya setup?",
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-slate-900 mb-6 leading-tight">
                CargoWise <span className="text-indigo-500">vs</span> Magaya
              </h1>
              
              <p className="text-lg md:text-xl text-slate-600 max-w-xl mb-8 leading-relaxed">
                Compare CargoWise and Magaya for logistics operations. 
            ...
            <div className="relative">
              ...
              <div className="relative bg-white rounded-3xl border border-slate-200 shadow-xl p-8">
                <svg viewBox="0 0 400 280" className="w-full h-auto">
                  ...
                  {/* Magaya Box */}
                  <rect x="230" y="40" width="150" height="200" rx="16" fill="#059669" opacity="0.1" stroke="#059669" strokeWidth="2"/>
                  <rect x="240" y="50" width="130" height="40" rx="8" fill="#059669"/>
                  <text x="305" y="75" textAnchor="middle" fill="white" fontSize="13" fontWeight="bold">Magaya</text>
                  
                  {/* Magaya Features */}
                  <rect x="255" y="105" width="100" height="12" rx="6" fill="#059669" opacity="0.3"/>
                  <rect x="255" y="125" width="80" height="12" rx="6" fill="#059669" opacity="0.3"/>
                  <rect x="255" y="145" width="90" height="12" rx="6" fill="#059669" opacity="0.3"/>
                  <rect x="255" y="165" width="70" height="12" rx="6" fill="#059669" opacity="0.3"/>
                  <rect x="255" y="185" width="85" height="12" rx="6" fill="#059669" opacity="0.3"/>
                  <rect x="255" y="205" width="60" height="12" rx="6" fill="#059669" opacity="0.3"/>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-slate-400 text-lg mb-8 leading-relaxed">
                Whether you choose CargoWise or Magaya, you are facing the same problem: 
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-4 p-6 bg-slate-50 rounded-xl border border-slate-100">
                ...
                <div>
                  ...
                  <p className="text-slate-600">
                    Clean data integration to your ERP. DocStandard bridges CargoWise and Magaya 
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-8 rounded-2xl bg-gradient-to-br from-indigo-50 to-white border border-indigo-100">
              ...
              <p className="text-slate-600">
                Works with CargoWise, Magaya, or any platform. We normalize data 
            ...
            <div className="p-8 rounded-2xl bg-gradient-to-br from-indigo-50 to-white border border-indigo-100">
              ...
              <p className="text-slate-600">
                ...
                whether you use CargoWise or Magaya.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-8 rounded-2xl bg-slate-50 border border-slate-200">
              ...
              <p className="text-slate-700 mb-6">
                &quot;We evaluated both CargoWise and Magaya. DocStandard made the data 
