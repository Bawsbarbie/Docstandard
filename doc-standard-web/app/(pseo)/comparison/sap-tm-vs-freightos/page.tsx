...
export const metadata: Metadata = {
  title: "SAP TM vs Freightos (2026): TMS Comparison | DocStandard",
  description: "Compare SAP TM and Freightos side-by-side. Features, pricing, integrations, and use cases for logistics operations.",
  alternates: { canonical: "https://docstandard.co/comparison/sap-tm-vs-freightos" },
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-slate-900 mb-6 leading-tight">SAP TM <span className="text-indigo-500">vs</span> Freightos</h1>
              <p className="text-lg md:text-xl text-slate-600 max-w-xl mb-8 leading-relaxed">Compare SAP TM and Freightos for logistics operations.</p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-slate-400 text-lg mb-8">Whether you choose SAP TM or Freightos, you are facing the same problem: getting clean data into your accounting system.</p>
      ...
      <section id="comparison-table" className="py-20 px-6 bg-slate-50">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden shadow-sm">
            ...
            <div className="grid grid-cols-3 border-b border-slate-100"><div className="px-6 py-4 font-medium text-slate-900">Starting Price</div><div className="px-6 py-4 text-center text-slate-600">$250K/year</div><div className="px-6 py-4 text-center text-slate-600">Free to compare</div></div>
            <div className="grid grid-cols-3"><div className="px-6 py-4 font-medium text-slate-900">Target Market</div><div className="px-6 py-4 text-center text-slate-600">Large enterprises</div><div className="px-6 py-4 text-center text-slate-600">Rate shoppers</div></div>
          </div>
        </div>
      </section>
