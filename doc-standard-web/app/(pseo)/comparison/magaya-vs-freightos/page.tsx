...
export const metadata: Metadata = {
  title: "Magaya vs Freightos (2026): TMS Comparison | DocStandard",
  description:
    "Compare Magaya and Freightos side-by-side. Features, pricing, integrations, and use cases for logistics operations.",
  alternates: {
    canonical: "https://docstandard.co/comparison/magaya-vs-freightos",
  },
  robots: {
    index: false,
    follow: false,
...
const comparisonFeatures = [
  { feature: "Category", "magaya": "TMS", "freightos": "Forwarder" },
  { feature: "Starting Price", "magaya": "$500/month", "freightos": "Free to compare" },
  { feature: "Target Market", "magaya": "SMB (&lt;$50M)", "freightos": "Rate shoppers" },
  { feature: "Best For", "magaya": "Freight forwarding", "freightos": "International shipping" },
  { feature: "Implementation", "magaya": "2-6 weeks", "freightos": "1-4 weeks" },
  { feature: "Integration Type", "magaya": "REST API / Custom", "freightos": "REST API / Custom" },
  { feature: "Cloud/On-prem", "magaya": "Cloud-native", "freightos": "Cloud-native" },
  { feature: "Mobile Support", "magaya": "✓ Limited to Full", "freightos": "✓ Limited to Full" },
  { feature: "API Available", "magaya": "✓ Yes", "freightos": "✓ Yes" },
  { feature: "DocStandard Compatible", "magaya": "✓ Yes", "freightos": "✓ Yes" },
  { feature: "Data Extraction", "magaya": "PDF, Email, API, EDI", "freightos": "PDF, Email, API, EDI" },
  { feature: "Common Pain Point", "magaya": "ERP integration gaps", "freightos": "Data export limitations" },
]

const painPoints = [
  {
    title: "Data Format Mismatch",
    description: "Magaya and Freightos use different data formats. Getting data between them requires manual reformatting or expensive custom integration."
  },
  {
  ...
  },
  {
    ...
    description: "Building custom integration between Magaya and Freightos requires expensive developers and ongoing maintenance."
  }
]
...
const faqs = [
  ...
  {
    q: "We're migrating from Magaya to Freightos. How can DocStandard simplify the data transfer?",
    a: "DocStandard normalizes and transforms records between Magaya and Freightos during migration. We handle complex field mapping and data validation, saving 3-4 weeks of migration time and ensuring data integrity across systems."
  },
  {
  ...
  {
    q: "We have clients using both Magaya and Freightos. Can DocStandard normalize data from both platforms?",
    a: "Absolutely. DocStandard accepts data from both Magaya and Freightos, normalizes it to a standard schema, and delivers consistent output to your ERP—regardless of which platforms your partners use."
  },
  {
    q: "How quickly can DocStandard integrate with our existing Magaya or Freightos setup?",
...
export default function MagayaVsFreightosPage() {
  return (
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-slate-900 mb-6 leading-tight">
                Magaya <span className="text-indigo-500">vs</span> Freightos
              </h1>
              
              <p className="text-lg md:text-xl text-slate-600 max-w-xl mb-8 leading-relaxed">
                Compare Magaya and Freightos for logistics operations. 
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-slate-400 text-lg mb-8 leading-relaxed">
                Whether you choose Magaya or Freightos, you are facing the same problem: 
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-4 p-6 bg-slate-50 rounded-xl border border-slate-100">
                ...
                <div>
                  ...
                  <p className="text-slate-600">
                    Clean data integration to your ERP. DocStandard bridges Magaya and Freightos 
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-8 rounded-2xl bg-gradient-to-br from-indigo-50 to-white border border-indigo-100">
              ...
              <p className="text-slate-600">
                Works with Magaya, Freightos, or any platform. We normalize data 
            ...
            <div className="p-8 rounded-2xl bg-gradient-to-br from-indigo-50 to-white border border-indigo-100">
              ...
              <p className="text-slate-600">
                ...
                whether you use Magaya or Freightos.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-8 rounded-2xl bg-slate-50 border border-slate-200">
              ...
              <p className="text-slate-700 mb-6">
                &quot;We evaluated both Magaya and Freightos. DocStandard made the data 
