...
export const metadata: Metadata = {
  title: "CargoWise vs In-House Team (2026): TMS Comparison | DocStandard",
  description:
    "Compare CargoWise and In-House Team side-by-side. Features, pricing, integrations, and use cases for logistics operations.",
  alternates: {
    canonical: "https://docstandard.co/comparison/cargowise-vs-in-house-team",
  },
  robots: {
    index: false,
    follow: false,
...
const comparisonFeatures = [
  { feature: "Category", "cargowise": "TMS", "in-house-team": "Tools" },
  { feature: "Starting Price", "cargowise": "$50K/year", "in-house-team": "$45-65K/year" },
  { feature: "Target Market", "cargowise": "Enterprise ($50M+)", "in-house-team": "Organizations with steady volume" },
  { feature: "Best For", "cargowise": "Freight forwarding", "in-house-team": "Process automation" },
  { feature: "Implementation", "cargowise": "3-12 months", "in-house-team": "3-12 months" },
  { feature: "Integration Type", "cargowise": "eAdapter (XML)", "in-house-team": "Varies" },
  { feature: "Cloud/On-prem", "cargowise": "Cloud-native", "in-house-team": "N/A" },
  { feature: "Mobile Support", "cargowise": "✓ Limited to Full", "in-house-team": "N/A" },
  { feature: "API Available", "cargowise": "✓ Yes", "in-house-team": "✓ Yes" },
  { feature: "DocStandard Compatible", "cargowise": "✓ Yes", "in-house-team": "✓ Yes" },
  { feature: "Data Extraction", "cargowise": "PDF, Email, API, EDI", "in-house-team": "Varies" },
  { feature: "Common Pain Point", "cargowise": "ERP integration gaps", "in-house-team": "Error rates / Scalability" },
]

const painPoints = [
  {
    title: "Data Format Mismatch",
    description: "CargoWise and In-House Team use different data formats. Getting data between them requires manual reformatting or expensive custom integration."
  },
  {
  ...
  },
  {
    ...
    description: "Building custom integration between CargoWise and In-House Team requires expensive developers and ongoing maintenance."
  }
]
...
const faqs = [
  ...
  {
    q: "We're migrating from CargoWise to In-House Team. How can DocStandard simplify the data transfer?",
    a: "DocStandard normalizes and transforms records between CargoWise and In-House Team during migration. We handle complex field mapping and data validation, saving 3-4 weeks of migration time and ensuring data integrity across systems."
  },
  {
  ...
  {
    q: "We have clients using both CargoWise and In-House Team. Can DocStandard normalize data from both platforms?",
    a: "Absolutely. DocStandard accepts data from both CargoWise and In-House Team, normalizes it to a standard schema, and delivers consistent output to your ERP—regardless of which platforms your partners use."
  },
  {
    q: "How quickly can DocStandard integrate with our existing CargoWise or In-House Team setup?",
...
export default function CargowiseVsInHouseTeamPage() {
  return (
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-slate-900 mb-6 leading-tight">
                CargoWise <span className="text-indigo-500">vs</span> In-House Team
              </h1>
              
              <p className="text-lg md:text-xl text-slate-600 max-w-xl mb-8 leading-relaxed">
                Compare CargoWise and In-House Team for logistics operations. 
            ...
            <div className="relative">
              ...
              <div className="relative bg-white rounded-3xl border border-slate-200 shadow-xl p-8">
                <svg viewBox="0 0 400 280" className="w-full h-auto">
                  ...
                  <text x="305" y="75" textAnchor="middle" fill="white" fontSize="10" fontWeight="bold">In-House Team</text>
                  
                  {/* In-House Team Features */}
                  <rect x="255" y="105" width="100" height="12" rx="6" fill="#f59e0b" opacity="0.3"/>
                  <rect x="255" y="125" width="80" height="12" rx="6" fill="#f59e0b" opacity="0.3"/>
                  <rect x="255" y="145" width="90" height="12" rx="6" fill="#f59e0b" opacity="0.3"/>
                  <rect x="255" y="165" width="70" height="12" rx="6" fill="#f59e0b" opacity="0.3"/>
                  <rect x="255" y="185" width="85" height="12" rx="6" fill="#f59e0b" opacity="0.3"/>
                  <rect x="255" y="205" width="60" height="12" rx="6" fill="#f59e0b" opacity="0.3"/>
                ...
                <div className="flex justify-between mt-4 px-4">
                  ...
                  <div className="text-center">
                    <div className="w-3 h-3 rounded-full bg-amber-600 mx-auto mb-1"></div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-slate-400 text-lg mb-8 leading-relaxed">
                Whether you choose CargoWise or In-House Team, you are facing the same problem: 
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden shadow-sm">
            ...
            <div className="grid grid-cols-3 bg-slate-100 border-b border-slate-200">
              ...
              <div className="px-6 py-4 font-bold text-center text-amber-700 bg-amber-50">In-House Team</div>
            </div>
            ...
            {comparisonFeatures.map((row, index) => (
              ...
              >
                ...
                <div className="px-6 py-4 text-center text-slate-600">{row["in-house-team"]}</div>
              </div>
            ))}
          </div>
          ...
          <div className="mt-8 grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-white p-6 rounded-xl border border-slate-200">
              <h4 className="font-semibold text-slate-900 mb-2">In-House Team Advantage</h4>
              <p className="text-sm text-slate-600">
                Best suited for Organizations with steady volume operations with tools focus.
              </p>
            </div>
            <div className="bg-white p-6 rounded-xl border border-slate-200">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            <div>
              ...
              <div className="rounded-2xl bg-indigo-50 border border-indigo-100 p-6">
                ...
                <div>
                  <div className="flex items-center gap-2 text-indigo-700 font-medium mb-2">
                    <CheckCircle className="w-4 h-4" />
                    In-House Team Best For
                  </div>
                  <p className="text-slate-600">Organizations with steady volume businesses needing tools capabilities.</p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-4 p-6 bg-slate-50 rounded-xl border border-slate-100">
                ...
                <div>
                  <h3 className="font-bold text-slate-900 mb-2">Choose In-House Team If...</h3>
                  <p className="text-slate-600">
                    You are organizations with steady volume, need tools functionality, 
                    and your budget aligns with $45-65K/year pricing.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4 p-6 bg-slate-50 rounded-xl border border-slate-100">
                ...
                <div>
                  ...
                  <p className="text-slate-600">
                    Clean data integration to your ERP. DocStandard bridges CargoWise and In-House Team 
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-8 rounded-2xl bg-gradient-to-br from-indigo-50 to-white border border-indigo-100">
              ...
              <p className="text-slate-600">
                Works with CargoWise, In-House Team, or any platform. We normalize data 
            ...
            <div className="p-8 rounded-2xl bg-gradient-to-br from-indigo-50 to-white border border-indigo-100">
              ...
              <p className="text-slate-600">
                ...
                whether you use CargoWise or In-House Team.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-8 rounded-2xl bg-slate-50 border border-slate-200">
              ...
              <p className="text-slate-700 mb-6">
                &quot;We evaluated both CargoWise and In-House Team. DocStandard made the data 
