...
export const metadata: Metadata = {
  title: "CargoWise vs Freightos (2026): TMS Comparison | DocStandard",
  description:
    "Compare CargoWise and Freightos side-by-side. Features, pricing, integrations, and use cases for logistics operations.",
  alternates: {
    canonical: "https://docstandard.co/comparison/cargowise-vs-freightos",
  },
  robots: {
    index: false,
    follow: false,
...
const comparisonFeatures = [
  { feature: "Category", "cargowise": "TMS", "freightos": "Forwarder" },
  { feature: "Starting Price", "cargowise": "$50K/year", "freightos": "Free to compare" },
  { feature: "Target Market", "cargowise": "Enterprise ($50M+)", "freightos": "Rate shoppers" },
  { feature: "Best For", "cargowise": "Freight forwarding", "freightos": "International shipping" },
  { feature: "Implementation", "cargowise": "3-12 months", "freightos": "1-4 weeks" },
  { feature: "Integration Type", "cargowise": "eAdapter (XML)", "freightos": "REST API / Custom" },
  { feature: "Cloud/On-prem", "cargowise": "Cloud-native", "freightos": "Cloud-native" },
  { feature: "Mobile Support", "cargowise": "✓ Limited to Full", "freightos": "✓ Limited to Full" },
  { feature: "API Available", "cargowise": "✓ Yes", "freightos": "✓ Yes" },
  { feature: "DocStandard Compatible", "cargowise": "✓ Yes", "freightos": "✓ Yes" },
  { feature: "Data Extraction", "cargowise": "PDF, Email, API, EDI", "freightos": "PDF, Email, API, EDI" },
  { feature: "Common Pain Point", "cargowise": "ERP integration gaps", "freightos": "Data export limitations" },
]

const painPoints = [
  {
    title: "Data Format Mismatch",
    description: "CargoWise and Freightos use different data formats. Getting data between them requires manual reformatting or expensive custom integration."
  },
  {
  ...
  },
  {
    ...
    description: "Building custom integration between CargoWise and Freightos requires expensive developers and ongoing maintenance."
  }
]
...
const faqs = [
  ...
  {
    q: "We're migrating from CargoWise to Freightos. How can DocStandard simplify the data transfer?",
    a: "DocStandard normalizes and transforms records between CargoWise and Freightos during migration. We handle complex field mapping and data validation, saving 3-4 weeks of migration time and ensuring data integrity across systems."
  },
  {
  ...
  {
    q: "We have clients using both CargoWise and Freightos. Can DocStandard normalize data from both platforms?",
    a: "Absolutely. DocStandard accepts data from both CargoWise and Freightos, normalizes it to a standard schema, and delivers consistent output to your ERP—regardless of which platforms your partners use."
  },
  {
    q: "How quickly can DocStandard integrate with our existing CargoWise or Freightos setup?",
...
export default function CargowiseVsFreightosPage() {
  return (
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-slate-900 mb-6 leading-tight">
                CargoWise <span className="text-indigo-500">vs</span> Freightos
              </h1>
              
              <p className="text-lg md:text-xl text-slate-600 max-w-xl mb-8 leading-relaxed">
                Compare CargoWise and Freightos for logistics operations. 
            ...
            <div className="relative">
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-indigo-100/50 to-teal-100/50 rounded-3xl blur-3xl" />
              ...
              <div className="relative bg-white rounded-3xl border border-slate-200 shadow-xl p-8">
                <svg viewBox="0 0 400 280" className="w-full h-auto">
                  ...
                  <text x="305" y="75" textAnchor="middle" fill="white" fontSize="13" fontWeight="bold">Freightos</text>
                ...
                <div className="flex justify-between mt-4 px-4">
                  ...
                  <div className="text-center">
                    <div className="w-3 h-3 rounded-full bg-teal-600 mx-auto mb-1"></div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-slate-400 text-lg mb-8 leading-relaxed">
                Whether you choose CargoWise or Freightos, you are facing the same problem: 
            ...
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-r from-indigo-500/20 to-teal-500/20 rounded-2xl blur-2xl" />
      ...
      <section id="comparison-table" className="py-20 px-6 bg-slate-50">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mt-8 grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-white p-6 rounded-xl border border-slate-200">
              <h4 className="font-semibold text-slate-900 mb-2">Freightos Advantage</h4>
              <p className="text-sm text-slate-600">
                Best suited for Rate shoppers operations with forwarder focus.
              </p>
            </div>
            <div className="bg-white p-6 rounded-xl border border-slate-200">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            <div>
              ...
              <div className="rounded-2xl bg-indigo-50 border border-indigo-100 p-6">
                ...
                <div>
                  ...
                  <p className="text-slate-600">Rate shoppers businesses needing forwarder capabilities.</p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-4 p-6 bg-slate-50 rounded-xl border border-slate-100">
                ...
                <div>
                  <h3 className="font-bold text-slate-900 mb-2">Choose Freightos If...</h3>
                  <p className="text-slate-600">
                    You are rate shoppers, need forwarder functionality, 
                    and your budget aligns with Free to compare pricing.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4 p-6 bg-slate-50 rounded-xl border border-slate-100">
                ...
                <div>
                  ...
                  <p className="text-slate-600">
                    Clean data integration to your ERP. DocStandard bridges CargoWise and Freightos 
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-8 rounded-2xl bg-gradient-to-br from-indigo-50 to-white border border-indigo-100">
              ...
              <p className="text-slate-600">
                Works with CargoWise, Freightos, or any platform. We normalize data 
            ...
            <div className="p-8 rounded-2xl bg-gradient-to-br from-indigo-50 to-white border border-indigo-100">
              ...
              <p className="text-slate-600">
                ...
                whether you use CargoWise or Freightos.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-8 rounded-2xl bg-slate-50 border border-slate-200">
              ...
              <p className="text-slate-700 mb-6">
                &quot;We evaluated both CargoWise and Freightos. DocStandard made the data 
