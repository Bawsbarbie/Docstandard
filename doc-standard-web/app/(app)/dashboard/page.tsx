    ...
    <div className={`${manrope.variable} ${sora.variable} dashboard-console`}>
      ...
      {isOnboardingOpen && (
        <div className="fixed inset-0 z-40 flex items-center justify-center bg-slate-900/80 backdrop-blur-sm">
          <div className="panel w-full max-w-lg overflow-hidden m-4">
            <div className="p-8">
              <div className="text-center mb-8">
                <h2 className="text-2xl font-bold text-slate-900">Welcome to DocStandard</h2>
              </div>

              <div className="flex justify-between mb-8 relative">
                <div className="absolute top-1/2 left-0 right-0 h-0.5 bg-slate-100 -z-10 transform -translate-y-1/2"></div>
                {[1, 2, 3].map((step) => {
              ...
              {onboardingStep === 1 && (
                <div className="animate-fade-in">
                  <h3 className="text-xl font-bold text-slate-900 mb-4 text-center">Clean Data, Fast Delivery</h3>
                  <p className="text-slate-500 text-center mb-6">
                    We transform your messy documents into structured data for your B2B needs.
                  </p>
                  ...
                  <button
                    ...
                    className="w-full py-3 bg-[#2563eb] text-white rounded-lg font-medium hover:bg-[#1d4ed8]"
                  >
                    Next Step
                  </button>
                </div>
              ...
              {onboardingStep === 2 && (
                <div className="animate-fade-in">
                  <h3 className="text-xl font-bold text-slate-900 mb-4 text-center">The Process</h3>
                  <div className="space-y-4 mb-8">
                    {["Choose Plan", "Upload Files", "Download Data"].map((label, index) => (
                      <div key={label} className="flex gap-4">
                        <span className="flex-shrink-0 w-8 h-8 bg-blue-100 text-[#2563eb] rounded-full flex items-center justify-center font-bold">
                          {index + 1}
                        </span>
                        <div>
                          ...
                          <p className="text-sm text-slate-500">
                            {index === 0
                              ? "Economy, Standard, or Rush delivery."
                              : index === 1
                                ? "Drag & drop your PDFs or Images."
                                : "Get clean CSV, JSON, or XML outputs."}
                          </p>
                        </div>
                      </div>
                    ))}
                  ...
                  <div className="flex gap-3">
                    ...
                    <button
                      ...
                      className="flex-1 py-3 bg-[#2563eb] text-white rounded-lg font-medium hover:bg-[#1d4ed8]"
                    >
                      Next
                    </button>
                  </div>
              ...
              {onboardingStep === 3 && (
                <div className="animate-fade-in">
                  <h3 className="text-xl font-bold text-slate-900 mb-4 text-center">Ready to Start?</h3>
                  <div className="bg-blue-50 p-5 rounded-xl text-center mb-8">
                    <p className="text-blue-800 font-medium mb-2">Smart Credit System</p>
                    <p className="text-sm text-blue-600">
                      Buy credits now, use them later. Unused credits never expire and roll over to your next project.
                    </p>
                  </div>
                  <button
                    type="button"
                    onClick={() => setIsOnboardingOpen(false)}
                    className="w-full py-3 bg-[#2563eb] text-white rounded-lg font-bold hover:bg-[#1d4ed8] shadow-[0_12px_24px_rgba(37,99,235,0.25)]"
                  >
                    Get Started
                  </button>
                </div>
