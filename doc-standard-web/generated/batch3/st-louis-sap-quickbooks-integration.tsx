...
export default function V2Page({
  ...
  systemA = "SAP",
  systemB = "QuickBooks",
  hub = "St. Louis Logistics Hub",
  port = "Port of St. Louis",
  carriers = ["Maersk"],
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Service",
            name: `SAP to QuickBooks Integration in St. Louis`,
      ...
      <section className="pt-4 pb-6">
        <div className="max-w-7xl mx-auto px-4">
          <Hero
            intro={{
              id: "intro",
              text: `Expert document processing services for St. Louis Logistics Hub logistics operations.`,
            }}
            pain={{
              id: "hero-pain",
              text: `Manual SAP exports and QuickBooks imports slow St. Louis teams.`,
            }}
            intentName={`SAP to QuickBooks Integration in St. Louis`}
            systemA={systemA}
            systemB={systemB}
            visual="data-card"
            showVisual={true}
        ...
        <div className="max-w-7xl mx-auto px-4">
          <TechnicalGuide
            integrationGuide={{
              systemA,
              systemB,
              friction: `Manual SAP exports to QuickBooks in St. Louis`,
              solution: `DocStandard normalizes SAP and QuickBooks data for St. Louis Logistics Hub operations`,
      ...
      <section className="py-6 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <TechnicalProcess
            process={{
              id: "process",
              title: `The DocStandard Approach for St. Louis`,
              steps: [
                { name: "Upload", desc: `Send your SAP exports from St. Louis` },
      ...
      <section className="pt-6 pb-24">
        <div className="max-w-7xl mx-auto px-4">
          <div className="mt-12 max-w-3xl mx-auto text-center pb-6">
            ...
            <p className="text-slate-700 leading-relaxed mb-4">
              {`The $176,720/year annual savings figure is based on three measurable factors: labor time reduction, error cost avoidance, and operational capacity recovery. For a typical St. Louis operation processing SAP to QuickBooks transfers, manual data entry and cleanup consumes 26 hours/week per week. At an average operations specialist rate of $35/hour, this translates to significant labor costs that compound over time.`}
            </p>
            <p className="text-slate-700 leading-relaxed mb-4">
