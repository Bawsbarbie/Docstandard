      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Service",
            name: `Magaya to Oracle Integration in Phoenix`,
      ...
      <section className="pt-4 pb-6">
        <div className="max-w-7xl mx-auto px-4">
          <Hero
            ...
            pain={{
              id: "hero-pain",
              text: `Manual Magaya exports and Oracle imports slow Phoenix teams.`,
            }}
            intentName={`Magaya to Oracle Integration in Phoenix`}
            systemA={systemA}
            systemB={systemB}
            visual="data-card"
            showVisual={true}
        ...
        <div className="max-w-7xl mx-auto px-4">
          <TechnicalGuide
            integrationGuide={{
              systemA,
              systemB,
              friction: `Manual Magaya exports to Oracle in Phoenix`,
              solution: `DocStandard normalizes Magaya and Oracle data for Phoenix Logistics Hub operations`,
        ...
        <div className="max-w-7xl mx-auto px-4">
          <TechnicalProcess
            process={{
              ...
              steps: [
                { name: "Upload", desc: `Send your Magaya exports from Phoenix` },
      ...
      <section className="pt-6 pb-24">
        <div className="max-w-7xl mx-auto px-4">
          <div className="mt-12 max-w-3xl mx-auto text-center pb-6">
            ...
            <p className="text-slate-700 leading-relaxed mb-4">
              {`The $75,129/year annual savings figure is based on three measurable factors: labor time reduction, error cost avoidance, and operational capacity recovery. For a typical Phoenix operation processing Magaya to Oracle transfers, manual data entry and cleanup consumes 20 hours/week per week. At an average operations specialist rate of $35/hour, this translates to significant labor costs that compound over time.`}
            </p>
            <p className="text-slate-700 leading-relaxed mb-4">
