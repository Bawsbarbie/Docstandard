...
export default function V2Page({
  ...
  manualEffort = "28 hours/week",
  withDocStandard = "5 minutes",
  annualSavings = "$56,865/year",
  errorReduction = "100%",
  faqs = [],
  testimonials = [],
}: V2PageProps) {
  ...
  const resolvedTestimonials = (testimonials.length > 0
    ...
    : [
          {
            quote: `Connecting Magaya to Oracle used to be a nightmare. DocStandard eliminated manual re-keying and the data arrives clean every time. Our month-end close is smooth and accurate, and the ops team finally has time back. The turnaround has been consistently reliable.`,
            author: "Jordan Miles",
            role: "Operations Lead",
            company: "North River Logistics",
          },
          {
            quote: `We stopped re-keying Magaya exports and closed reconciliation gaps in Oracle after the first batch. DocStandard caught formatting issues we missed, so imports now pass validation. The savings in cleanup time and audit headaches have been immediate and measurable.`,
            author: "Priya Shah",
            role: "Controller",
            company: "Summit Freight Group",
          },
          {
            quote: `DocStandard mapped our Magaya fields to Oracle correctly on the first pass. No back-and-forth, no rework. The team understood both systems, flagged risks early, and delivered clean files that just work. Integration is now predictable and low-maintenance.`,
            author: "Carlos Vega",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Service",
            name: `Magaya to Oracle Integration in Salt Lake City`,
      ...
      <section className="pt-4 pb-6">
        <div className="max-w-7xl mx-auto px-4">
          <Hero
            ...
            pain={{
              id: "hero-pain",
              text: `Manual Magaya exports and Oracle imports slow Salt Lake City teams.`,
            }}
            intentName={`Magaya to Oracle Integration in Salt Lake City`}
            systemA={systemA}
            systemB={systemB}
            visual="data-card"
            showVisual={true}
        ...
        <div className="max-w-7xl mx-auto px-4">
          <TechnicalGuide
            integrationGuide={{
              systemA,
              systemB,
              friction: `Manual Magaya exports to Oracle in Salt Lake City`,
              solution: `DocStandard normalizes Magaya and Oracle data for Salt Lake City Logistics Hub operations`,
        ...
        <div className="max-w-7xl mx-auto px-4">
          <TechnicalProcess
            process={{
              ...
              steps: [
                { name: "Upload", desc: `Send your Magaya exports from Salt Lake City` },
      ...
      <section className="pt-6 pb-24">
        <div className="max-w-7xl mx-auto px-4">
          <div className="mt-12 max-w-3xl mx-auto text-center pb-6">
            ...
            <p className="text-slate-700 leading-relaxed mb-4">
              {`The $56,865/year annual savings figure is based on three measurable factors: labor time reduction, error cost avoidance, and operational capacity recovery. For a typical Salt Lake City operation processing Magaya to Oracle transfers, manual data entry and cleanup consumes 28 hours/week per week. At an average operations specialist rate of $35/hour, this translates to significant labor costs that compound over time.`}
            </p>
            <p className="text-slate-700 leading-relaxed mb-4">
