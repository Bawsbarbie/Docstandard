...
export default function V2Page({
  ...
  systemA = "SAP",
  systemB = "QuickBooks",
  hub = "Salt Lake City Logistics Hub",
  port = "Salt Lake City Airport",
  carriers = ["Evergreen"],
  ...
  const resolvedTestimonials = (testimonials.length > 0
    ...
    : [
          {
            quote: `Connecting SAP to QuickBooks used to be a nightmare. DocStandard eliminated manual re-keying and the data arrives clean every time. Our month-end close is smooth and accurate, and the ops team finally has time back. The turnaround has been consistently reliable.`,
            author: "Jordan Miles",
            role: "Operations Lead",
            company: "North River Logistics",
          },
          {
            quote: `We stopped re-keying SAP exports and closed reconciliation gaps in QuickBooks after the first batch. DocStandard caught formatting issues we missed, so imports now pass validation. The savings in cleanup time and audit headaches have been immediate and measurable.`,
            author: "Priya Shah",
            role: "Controller",
            company: "Summit Freight Group",
          },
          {
            quote: `DocStandard mapped our SAP fields to QuickBooks correctly on the first pass. No back-and-forth, no rework. The team understood both systems, flagged risks early, and delivered clean files that just work. Integration is now predictable and low-maintenance.`,
            author: "Carlos Vega",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Service",
            name: `SAP to QuickBooks Integration in Salt Lake City`,
      ...
      <section className="pt-4 pb-6">
        <div className="max-w-7xl mx-auto px-4">
          <Hero
            intro={{
              id: "intro",
              text: `Expert document processing services for Salt Lake City Logistics Hub logistics operations.`,
            }}
            pain={{
              id: "hero-pain",
              text: `Manual SAP exports and QuickBooks imports slow Salt Lake City teams.`,
            }}
            intentName={`SAP to QuickBooks Integration in Salt Lake City`}
            systemA={systemA}
            systemB={systemB}
            visual="data-card"
            showVisual={true}
        ...
        <div className="max-w-7xl mx-auto px-4">
          <TechnicalGuide
            integrationGuide={{
              systemA,
              systemB,
              friction: `Manual SAP exports to QuickBooks in Salt Lake City`,
              solution: `DocStandard normalizes SAP and QuickBooks data for Salt Lake City Logistics Hub operations`,
      ...
      <section className="py-6 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <TechnicalProcess
            process={{
              id: "process",
              title: `The DocStandard Approach for Salt Lake City`,
              steps: [
                { name: "Upload", desc: `Send your SAP exports from Salt Lake City` },
      ...
      <section className="pt-6 pb-24">
        <div className="max-w-7xl mx-auto px-4">
          <div className="mt-12 max-w-3xl mx-auto text-center pb-6">
            ...
            <p className="text-slate-700 leading-relaxed mb-4">
              {`The $164,108/year annual savings figure is based on three measurable factors: labor time reduction, error cost avoidance, and operational capacity recovery. For a typical Salt Lake City operation processing SAP to QuickBooks transfers, manual data entry and cleanup consumes 14 hours/week per week. At an average operations specialist rate of $35/hour, this translates to significant labor costs that compound over time.`}
            </p>
            <p className="text-slate-700 leading-relaxed mb-4">
