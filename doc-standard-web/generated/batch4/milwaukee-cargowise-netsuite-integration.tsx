      ...
      <section className="pt-6 pb-24">
        <div className="max-w-7xl mx-auto px-4">
          <div className="mt-12 max-w-3xl mx-auto text-center pb-6">
            ...
            <p className="text-slate-700 leading-relaxed mb-4">
              {`The $35,702/year annual savings figure is based on three measurable factors: labor time reduction, error cost avoidance, and operational capacity recovery. For a typical Milwaukee operation processing CargoWise to NetSuite transfers, manual data entry and cleanup consumes 24 hours/week per week. At an average operations specialist rate of $35/hour, this translates to significant labor costs that compound over time.`}
            </p>
            <p className="text-slate-700 leading-relaxed mb-4">
