      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Service",
            name: `CargoWise to NetSuite Integration in Columbus`,
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-4">
          <Hero
            ...
            pain={{
              id: "hero-pain",
              text: `Manual CargoWise exports and NetSuite imports slow Columbus teams.`,
            }}
            intentName={`CargoWise to NetSuite Integration in Columbus`}
            systemA={systemA}
            systemB={systemB}
            visual="data-card"
            showVisual={true}
        ...
        <div className="max-w-7xl mx-auto px-4">
          <TechnicalGuide
            integrationGuide={{
              systemA,
              systemB,
              friction: `Manual CargoWise exports to NetSuite in Columbus`,
              solution: `DocStandard normalizes CargoWise and NetSuite data for Columbus Logistics Hub operations`,
        ...
        <div className="max-w-7xl mx-auto px-4">
          <TechnicalProcess
            process={{
              ...
              steps: [
                { name: "Upload", desc: `Send your CargoWise exports from Columbus` },
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="mt-12 max-w-3xl mx-auto">
            ...
            <p className="text-slate-700 leading-relaxed mb-4">
              The $135,411/year annual savings figure is based on three measurable factors: labor time reduction, error cost avoidance, and operational capacity recovery. For a typical Columbus operation processing CargoWise to NetSuite transfers, manual data entry and cleanup consumes 16 hours/week per week. At an average operations specialist rate of $35/hour, this translates to significant labor costs that compound over time.
            </p>
            <p className="text-slate-700 leading-relaxed mb-4">
